  ...
  constructor (sock = null, delim = '<') {
    ...
    sock.on('data', buf => {
      ...
      while (data.length > 1) {
        ...
        this.emit(obj.type, obj.content, obj.header);
      }
...
Node.SELF_INTRODUCTION = Node.prototype.SELF_INTRODUCTION = 'SELF_INTRODUCTION';
Node.CONNECTION_REFUSE = Node.prototype.CONNECTION_REFUSE = 'CONNECTION_REFUSE';
Node.CONNECTION_ACCEPT = Node.prototype.CONNECTION_ACCEPT = 'CONNECTION_ACCEPT';
Node.DISTANCE_VECTOR = Node.prototype.DISTANCE_VECTOR = 'DISTANCE_VECTOR';
Node.EDGE_LENGTH_CHANGED = Node.prototype.EDGE_LENGTH_CHANGED = 'EDGE_LENGTH_CHANGED';
Node.MESSAGE = Node.prototype.MESSAGE = 'MESSAGE';
